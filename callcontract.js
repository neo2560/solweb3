...
contractinstance.methods.buy().call(
{from: '0x75cb1ebc1bfafcdfe5c3c7dbf8cbb120dfa5ed72'}, function(err,x) {
console.log("err="+ err);
console.log(x);
});
...
contractinstance.methods.buy().call(
{from: '0x561c8cacee4b86629b6f07672468721b65377400'}).then(function(x) {
